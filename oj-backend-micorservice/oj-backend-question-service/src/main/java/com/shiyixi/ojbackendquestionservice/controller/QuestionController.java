package com.shiyixi.ojbackendquestionservice.controller;
...
import com.shiyixi.ojbackendmodel.dto.question.*;
...
public class QuestionController {
     ...
     * 提交做题
     *
     * @param questionSubmitAddRequest 提交添加参数
     * @param request                  request
     * @return resultNum 提交 id
     */
    ...
    public BaseResponse<Page<QuestionSubmitVO>> listQuestionSubmitByPage(@RequestBody QuestionSubmitQueryRequest questionSubmitQueryRequest,
        ...
        if (!StringUtils.isAnyBlank(userName)) { // 不为空
            ...
            questionSubmitQueryRequest.setUserName(null);
        }
