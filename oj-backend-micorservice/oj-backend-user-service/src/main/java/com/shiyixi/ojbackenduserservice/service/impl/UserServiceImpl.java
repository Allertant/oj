package com.shiyixi.ojbackenduserservice.service.impl;
...
import com.shiyixi.ojbackendmodel.dto.user.UserQueryRequest;
...
import com.shiyixi.ojbackenduserservice.mapper.UserMapper;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
    ...
    private final Object registerObj = new Object();
    ...
    public long userRegister(String userAccount, String userPassword, String checkPassword, String userName) {
        ...
        synchronized (registerObj) {
            ...
            // 删除验证码
            verifyCodeTemplate.removeCode(userAccount);
            return user.getId();
        }
    }
